      ...
      <div className='w-full h-[900px] border bg-white shadow-md rounded'>
        <div className='w-full px-8 pt-6 pb-8 mb-4 bg-white  rounded '>
          ...
          <form
            ...
            className='mt-5 p-8 rounded border shadow-md border-t-4 border-t-purple-500 '
          >
            {/* FIRST NAME */}
            ...
            <button
              type='submit'
              className=' bg-purple-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-1/6'
            >
              Save
            </button>

            <button className='bg-purple-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-1/6 ml-10'>
