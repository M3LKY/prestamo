...
export default function ClientsWidget() {
  ...
  return (
    <div className='w-full'>
      {/* CLIENTS */}
      <div
        className='mt-5 p-8 rounded-xl border border-t-4   cursor-pointer border-t-purple-500 hover:bg-purple-500
      ...
      >
        ...
        <span className='text-base text-gray-400 hover:text-white'>Total Clients Serviced</span>
      </div>
    </div>
  );
}
