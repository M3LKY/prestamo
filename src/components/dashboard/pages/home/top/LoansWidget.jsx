...
export default function LoansWidget() {
  ...
  return (
    <div className='w-full'>
      {/* Loans */}
      <div
        className='w-full  mt-5 p-8 rounded-xl cursor-pointer border border-t-4 border-t-purple-500 hover:bg-purple-500
      ...
      >
        ...
        <span className='text-base text-gray-500 hover:text-white'>
