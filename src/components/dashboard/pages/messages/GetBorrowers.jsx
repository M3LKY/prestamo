                  ...
                  clients.map((client, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td className='border px-4 py-2'>
                          <div className='flex'>
                            <button className='bg-purple-500 hover:bg-red-700 text-white font-bold py-2 px-2 mr-2 rounded focus:outline-none focus:shadow-outline w-full  '>
                              <Link to={`/Borrower/${client.id}`}>
                                <VisibilityOutlined className='text-sm' />
                              </Link>
                            </button>
                            <button
                              className='bg-purple-500 hover:bg-red-700 text-white font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline w-full '
