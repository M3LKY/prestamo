      ...
      <div className='w-full h-[900px] mx-auto px-8 py-8 mb-4 border bg-white shadow-md rounded'>
        <div className='w-full px-8 pt-6 pb-8 mb-4 bg-white  rounded'>
          ...
          <div className='flex items-center justify-between px-4 py-5 sm:px-6 bg-purple-200 rounded shadow-md '>
            {/* TITLE */}
            <div>
              <h3 className='text-lg font-medium leading-6 text-purple-400'>
          ...
          <form
            ...
            className='mt-5 p-8 h-[650px] rounded border shadow-md border-t-4 border-t-purple-500 '
          >
            <input
              type='text'
            ...
            <button className=' ml-5 text-center py-3 rounded bg-purple-500 text-white hover:bg-red-700 focus:outline-none my-1 w-1/5'>
