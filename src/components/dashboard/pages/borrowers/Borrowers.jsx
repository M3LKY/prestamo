    ...
    <div className="text-gray-900 h-[900px] flex">
      ...
      <div className="w-full h-[900px] mx-auto px-8 py-8 mb-4 border bg-white shadow-md rounded ">
        ...
        <div className="flex items-center justify-between border-y-2 mt-5">
          ...
          <button className="border hover:bg-red-700 bg-purple-500 text-white font-bold py-2 px-4 mb-2 rounded focus:outline-none focus:shadow-outline w-auto mt-2 mr-5">
            <Link to="/addBorrower">Add Borrower</Link>
          </button>
        </div>

        {/* INFO */}
        <div className="w-full h-[640px] px-4   mt-5 overflow-auto hover:overflow-scroll border rounded shadow-md border-t-4 border-t-purple-500 ">
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="border px-4 py-2 flex">
                        <button
                          className="bg-purple-500 hover:bg-red-700 text-white font-bold py-2 px-4  rounded focus:outline-none focus:shadow-outline w-full text-sm"
                          onClick={() => deleteClient(client.id)}
                        >
                          <DeleteForever className="text-lg" />
                        </button>
                        <button className="bg-purple-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full text-sm ml-2">
