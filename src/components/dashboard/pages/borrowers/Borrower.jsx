...
export default function Borrower({ setAuth }) {
  ...
  return (
    <div className="h-[900px]  flex">
      ...
      <div className="w-[1220px] h-[900px] mx-auto px-8 py-8 mb-4 border bg-white shadow-md rounded ">
        {/* BORROWER INFO */}
        {/* HEADER */}
        ...
        <div className="flex">
          {/* ACCOUNT INFO */}
          <div className="w-1/4 h-[720px] mt-5 border rounded shadow-md border-t-4 border-t-purple-500">
            <div className="py-5 px-5 ">
              <div className="flex flex-col justify-between items-center py-5 px-5 ">
                ...
                <div className="">
                  ...
                  <div className="flex items-center my-5">
                    <button className="bg-purple-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full ">
